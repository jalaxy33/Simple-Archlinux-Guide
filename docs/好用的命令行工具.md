...
[brush](https://github.com/reubeno/brush) 是一个基于 Rust 的 shell，可以完全替代 bash，兼容 `~/.bashrc`，提供了很多开箱即用的方便功能。
...
go语言开发的终端下载器，具有美观的TUI界面，支持多线程下载、指定镜像源等。
...
使用方法请查看[官方文档](https://github.com/surge-downloader/Surge)
...
[opencli](https://github.com/jackwener/OpenCLI) 提供了很多常用网页和 CLI 接口，详情请看[兼容的接口](https://github.com/jackwener/OpenCLI/blob/main/docs/adapters/index.md)。

```sh
sudo npm install -g @jackwener/opencli
```

安装后需要在浏览器中安装 [`OpenCLI`](https://chromewebstore.google.com/detail/opencli/ildkmabpimmkaediidaifkhjpohdnifk) 插件。
